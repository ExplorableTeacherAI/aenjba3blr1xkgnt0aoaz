    ...
    <StackLayout key="layout-intro-sports-day" maxWidth="xl">
        <Block id="intro-sports-day" padding="sm">
            <EditableParagraph id="para-intro-sports-day" blockId="intro-sports-day">
                ...
                school&apos;s true average means adding up all two hundred times, so instead you grab five
                runners at random and average only those. Then you do it again, and again, writing down
                each answer.
            </EditableParagraph>
        </Block>
    </StackLayout>,
